...
![Here we see the example of the first footnote in the chapter and the reference number  in the text.](images/footnotes-endnotes-sidenotes-and-popup-notes_01.png)  
...
![InDesign dialogue for controlling the display of the footnotes](images/footnotes-endnotes-sidenotes-and-popup-notes_02.png)  
...
![The layout of the footnotes is controlled through the second tab](images/footnotes-endnotes-sidenotes-and-popup-notes_03.png)  
...
![Here we see an enlargement of the page in InDesign. The numbers are now outdented from the left edge of the body text](images/footnotes-endnotes-sidenotes-and-popup-notes_04.png)  
...
![Endnotes at the end of the chapter.](images/footnotes-endnotes-sidenotes-and-popup-notes_05.png)  
...
![A spread with side notes. You see that the text alignment (left or right), is automatic depending on recto or verso achieved by the paragraph style using Towards the Spine.](images/footnotes-endnotes-sidenotes-and-popup-notes_06.png)  
...
![Pop-up notes using Apple iBooks on the MAC](images/footnotes-endnotes-sidenotes-and-popup-notes_07.png)  
...
![The hyperlink now comes from text not just a reference number](images/footnotes-endnotes-sidenotes-and-popup-notes_08.png)  
...
![Showing both pop-up and list of notes at the end of the chapter.](images/footnotes-endnotes-sidenotes-and-popup-notes_09.png)  
...
![The notes are at th endo of the eBook under their own heading but they also work as popup notes.](images/footnotes-endnotes-sidenotes-and-popup-notes_10.png)  
...
![Here we see entry for glossary that becomes a popup](images/footnotes-endnotes-sidenotes-and-popup-notes_11.png)  
...
![This glossary term is long so a scrollbar appears.](images/footnotes-endnotes-sidenotes-and-popup-notes_12.png)  
